    ...
    >
      ...
      <Container className="h-full w-11/12 xl:w-10/12">
        <div className="flex h-full w-full flex-col justify-center xl:w-6/12">
          <h2 className="mb-4 text-xl font-semibold text-brand-100 xl:text-3xl">
          ...
          <div className="w-10/12 xl:w-6/12">
            <Suspense>
              <ButtonWA
                className="overflow-hidden rounded-lg border border-transparent bg-brand-100 px-4 py-3 text-center text-base font-medium text-white hover:bg-brand-95"
