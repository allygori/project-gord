        ...
        <ul className="m-0 grid grid-cols-2 gap-6 p-0 lg:grid-cols-4">
          {STEPS.map((item, idx) => {
            return (
              <li
                key={idx}
                className="mx-auto flex h-40 w-40 flex-none flex-col items-center justify-center rounded-3xl bg-brand-90 bg-opacity-50 p-4 text-center md:p-8 lg:h-56 lg:w-56"
              >
                {/* point */}
